...
- Huber损失函数：$L_{\delta}(y_i-\hat{y}_{i})=\left\{\begin{array}{ll}{\frac{1}{2}(y_i-\hat{y}_i)^2} & {\text { if } |y-f(x)| \le \delta} \\ {\delta|y_i-\hat{y}_i|-\frac{1}{2}\delta^2} & {\text { else }}\end{array}\right.$
